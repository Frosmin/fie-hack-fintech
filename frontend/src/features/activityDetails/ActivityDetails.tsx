      ...
      try {
        ...
        const parsedData = rows.map((row) => {
          ...
          if (!nameCuate || nameCuate.toString().trim() === "") {
            ...
            const validOpts =
              formMode === "charge"
                ? "Depósito, Reembolso (o DEPOSIT, REFUND)"
                : "Pago, Retiro, Transferencia (o PAYMENT, WITHDRAWAL, TRANSFER)";
  ...
  if (error && !activity) {
    return (
      <section className="ad">
        ...
        <button className="ad__back" onClick={() => navigate(-1)}>
          ← Volver
        </button>
      </section>
    );
  ...
  return (
    <section className="ad">
      ...
      <div className="ad__hero-grid">
        ...
        <div className="ad__hero-card">
          ...
          <div className="ad__hero-balance-section">
            <div className="ad__hero-balance">
              ...
              <span
                className={`ad__hero-balance-value ${balance >= 0 ? "is-positive" : "is-negative"}`}
              >
                {formatMoney(balance)}
              </span>
            </div>
            <div className="ad__hero-meta-row">
              <span
                className={`ad__badge ${activity.isActive ? "ad__badge--active" : "ad__badge--inactive"}`}
              >
                <span className="ad__badge-dot" />
                {activity.isActive ? "Activa" : "Inactiva"}
              </span>
              <span className="ad__hero-date">
                {formatDate(activity.createdAt)}
              </span>
            </div>
            <div className="ad__hero-actions">
              <button
              ...
              <button
                className="ad__edit-activity-btn"
                onClick={() => {
                  setActivityForm({
                    name: activity.name,
        ...
        <div className="ad__qr-card">
          ...
          <div className="ad__quick-actions">
            <button
              className="ad__action-btn ad__action-btn--charge"
            ...
            <button
              className="ad__action-btn ad__action-btn--pay"
      ...
      <div className="ad__tx-section">
        ...
        {transactions.length === 0 ? (
          <div className="ad__tx-empty">
            ...
            <p>
              Registra tu primer cobro o pago para comenzar a ver el historial.
            </p>
            ...
            {transactions.map((tx) => {
              ...
              return (
                <div key={tx.id} className="ad__tx-row">
                  <div
                    className={`ad__tx-indicator ${isIncome ? "is-income" : "is-expense"}`}
                  >
                    {TYPE_ICONS[tx.type] || "•"}
                  </div>
                  <div className="ad__tx-body">
                    <div className="ad__tx-primary">
                      ...
                      <span
                        className={`ad__tx-amount ${isIncome ? "is-income" : "is-expense"}`}
                      >
                        {isIncome ? "+" : "−"}
                    ...
                    <div className="ad__tx-secondary">
                      <span className="ad__tx-type">
                        {TYPE_LABELS[tx.type]}
                      </span>
                      {tx.description && (
                        <span className="ad__tx-desc"> · {tx.description}</span>
                      )}
                      <span className="ad__tx-time">
                        {formatShortDate(tx.date)}
                      </span>
                    </div>
                  </div>
                  <span
                    className={`ad__tx-status ad__tx-status--${tx.status.toLowerCase()}`}
                  >
          ...
          <div className="ad__qr-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="ad__qr-modal-content">
              <img
                src="/qr_bueno.png"
                alt="Código QR BancoFie"
                className="ad__qr-modal-img"
              />
              <div className="ad__qr-modal-info">
                <h3>{activity.name}</h3>
                <p>
                  Escanea este código QR con tu app de BancoFie para realizar un
                  pago
                </p>
          ...
          <div className="ad__form-modal" onClick={(e) => e.stopPropagation()}>
            <div className="ad__form-header">
              <div className="ad__form-header-left">
                <div
                  className={`ad__form-mode-icon ${formMode === "pay" ? "is-pay" : "is-charge"}`}
                >
                  {formMode === "pay" ? (
                    <svg
                      width="20"
                ...
                <div>
                  <h3>
                    {formMode === "pay" ? "Registrar pago" : "Registrar cobro"}
                  </h3>
                  <span className="ad__form-subtitle">{activity.name}</span>
                </div>
              </div>
              <button
                className="ad__form-close"
            ...
            <form className="ad__form-body" onSubmit={handleSubmit}>
              ...
              <div className="ad__form-import-section">
                ...
                <div className="ad__form-import-info">
                  <span className="ad__form-import-label">
                    Importación masiva
                  </span>
                  <span className="ad__form-import-desc">
                    Importa varios movimientos desde un archivo Excel o CSV
                  </span>
                </div>
                <button
                  type="button"
      ...
      {showImportModal && (
        ...
        >
          <div
            className="ad__import-modal"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="ad__import-header">
              <h3>Importar transacciones</h3>
              <p>
                {formMode === "charge" ? "Modo cobro" : "Modo pago"} -{" "}
                {importData.length} filas
              </p>
              <button
                className="ad__import-close"
                onClick={() => {
                  setShowImportModal(false);
                  setImportData([]);
                }}
            ...
            <div className="ad__import-table-wrapper">
              ...
              {importData.length > 100 && (
                <p className="ad__import-note">
                  Mostrando las primeras 100 de {importData.length} filas
                </p>
              )}
            </div>
            ...
            <div className="ad__import-footer">
              ...
              <div className="ad__import-actions">
                ...
                <button
                  ...
                  disabled={
                    importing || importData.filter((r) => !r.error).length === 0
                  }
                >
                  {importing
                    ? "Importando..."
                    : `Importar ${importData.filter((r) => !r.error).length} transacciones`}
                </button>
              </div>
            </div>
          </div>
      ...
      {showActivityEditModal && (
        <div className="ad__overlay" onClick={() => setShowActivityEditModal(false)}>
          <div className="ad__activity-modal" onClick={(e) => e.stopPropagation()}>
            <div className="ad__form-header">
              <div className="ad__form-header-left">
                <div className="ad__form-mode-icon is-charge">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 24 24"
              ...
              <button
                className="ad__form-close"
                onClick={() => setShowActivityEditModal(false)}
                type="button"
              >
                <svg
                  width="20"
            ...
            <form className="ad__form-body" onSubmit={handleUpdateActivity}>
              <div className="ad__form-fields">
                <div className="ad__form-group">
                  <label htmlFor="act-edit-name">Nombre *</label>
                  <input
                    id="act-edit-name"
                    type="text"
                ...
                <div className="ad__form-group">
                  <label htmlFor="act-edit-desc">Descripcion</label>
                  <textarea
                    id="act-edit-desc"
              ...
              <div className="ad__form-footer">
                ...
                <button
                  type="submit"
                  className="ad__form-btn ad__form-btn--charge"
                  disabled={submittingActivity}
                >
                  {submittingActivity ? "Guardando..." : "Guardar cambios"}
                </button>
              </div>
            </form>
          </div>
